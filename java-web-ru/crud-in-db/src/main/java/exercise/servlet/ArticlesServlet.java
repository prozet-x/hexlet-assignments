...
public class ArticlesServlet extends HttpServlet {
    ...
    private void createArticle(HttpServletRequest request,
        ...
        try {
            PreparedStatement insertPrep = connection.prepareStatement(query);
            insertPrep.setString(1, title);
            insertPrep.setString(2, body);
            insertPrep.execute();
    ...
    private void updateArticle(HttpServletRequest request,
        ...
        try {
            ...
            PreparedStatement updateArticleStat = connection.prepareStatement(query);
            updateArticleStat.setString(1, title);
            updateArticleStat.setString(2, body);
            updateArticleStat.setLong(3, Long.parseLong(id));
            Boolean articleUpdated = updateArticleStat.execute();
        } catch (SQLException ex) {
            response.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
            return;
        }
    ...
    private void destroyArticle(HttpServletRequest request,
        ...
        try {
            ...
            PreparedStatement deleteStat = connection.prepareStatement(query);
            deleteStat.setLong(1, Long.parseLong(id));
            Boolean deleted = deleteStat.execute();
