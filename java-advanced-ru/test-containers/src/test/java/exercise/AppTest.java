...
public class AppTest {
    ...
    public static void makeAppProperties(DynamicPropertyRegistry registry) {
    ...
    void testGetAllPersons() throws Exception {
        ...
        assertThat(content).contains("John", "Jack", "Jassica", "Robert");
    }
    ...
    void testChangePerson() throws Exception {
        ...
        assertThat(responseGet.getContentAsString()).contains("Vova", "Putin");
    }
